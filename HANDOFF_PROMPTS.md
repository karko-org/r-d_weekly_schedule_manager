...
그 다음 0.weekly_schedule.html의 구조를 파악해주세요. 단일 HTML 파일에 HTML/CSS/JS가
...
node -e "
const fs = require('fs');
const html = fs.readFileSync('0.weekly_schedule.html', 'utf8');
...
### 샘플 파일로 테스트
1. 브라우저에서 `0.weekly_schedule.html` 열기
...
혹시 `0.weekly_schedule.html`이 손상되면:
